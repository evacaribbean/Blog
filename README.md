...
In older versions of Java it would have been necessary to load the driver by using `Class.forName();` or `DriverManager.registerDriver();`. But this is a later version. 
